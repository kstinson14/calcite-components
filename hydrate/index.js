...
class CalciteModal {
    ...
    render() {
        ...
        return (h(Host, { role: "dialog", "aria-modal": "true", class: { "is-active": this.isActive }, theme: theme }, h("div", { class: "modal" }, h("div", { "data-focus-fence": "true", tabindex: "0", onFocus: this.focusLastElement.bind(this) }), h("div", { class: "modal__header" }, h("button", { class: "modal__close", "aria-label": this.closeLabel, ref: el => (this.closeButton = el), onClick: () => this.close() }, h("calcite-icon", { icon: "x", scale: "m" })), h("header", { class: "modal__title" }, h("slot", { name: "header" }))), h("div", { class: {
                modal__content: true,
...
styles.set('sc-calcite-date-month-header','/*!\@:host([hidden])*/[hidden].sc-calcite-date-month-header-h{display:none}/*!\@.month-year*/.month-year.sc-calcite-date-month-header{display:-ms-flexbox;display:flex}/*!\@input*/input.sc-calcite-date-month-header{font-family:inherit;text-align:center}/*!\@.left-icon,.right-icon*/.left-icon.sc-calcite-date-month-header, .right-icon.sc-calcite-date-month-header{fill:var(--calcite-ui-text-3);-ms-flex-positive:1;flex-grow:1;outline:none;padding:0;border:none;color:inherit;background-color:var(--calcite-ui-foreground);cursor:pointer;-webkit-transition:all .15s ease-in-out;transition:all .15s ease-in-out}/*!\@.left-icon:focus,.left-icon:hover,.right-icon:focus,.right-icon:hover*/.left-icon.sc-calcite-date-month-header:focus, .left-icon.sc-calcite-date-month-header:hover, .right-icon.sc-calcite-date-month-header:focus, .right-icon.sc-calcite-date-month-header:hover{fill:var(--calcite-ui-text-1);background-color:var(--calcite-ui-foreground-hover)}/*!\@.left-icon:active,.right-icon:active*/.left-icon.sc-calcite-date-month-header:active, .right-icon.sc-calcite-date-month-header:active{background-color:var(--calcite-ui-foreground-pressed)}/*!\@.month-year-text*/.month-year-text.sc-calcite-date-month-header{padding:.5rem;display:-ms-inline-flexbox;display:inline-flex;-ms-flex-positive:1;flex-grow:1;width:50%;-ms-flex-pack:center;justify-content:center}/*!\@.month,.year*/.month.sc-calcite-date-month-header, .year.sc-calcite-date-month-header{color:var(--calcite-ui-text-1);background:var(--calcite-ui-foreground);font-size:1rem;line-height:1.5;font-weight:500}/*!\@.year*/.year.sc-calcite-date-month-header{border:none;width:60px;padding:0;margin:0}/*!\@input[type=number]*/input[type=number].sc-calcite-date-month-header{-moz-appearance:textfield}/*!\@input::-webkit-inner-spin-button,input::-webkit-outer-spin-button*/input.sc-calcite-date-month-header::-webkit-inner-spin-button, input.sc-calcite-date-month-header::-webkit-outer-spin-button{-webkit-appearance:none}');
...
styles.set('sc-calcite-tabs','/*!\@:host([hidden])*/[hidden].sc-calcite-tabs-h{display:none}/*!\@:host*/.sc-calcite-tabs-h{display:block;--calcite-tabs-layout:flex-start;--calcite-tabs-tab-basis:auto;--calcite-tabs-tab-text-align:start;--calcite-tabs-tab-margin-start:1.25rem;--calcite-tabs-tab-margin-end:0}/*!\@:host-context([dir=rtl])*/[dir=rtl].sc-calcite-tabs-h, [dir=rtl] .sc-calcite-tabs-h{--calcite-tabs-tab-margin-start:0;--calcite-tabs-tab-margin-end:1.25rem}/*!\@:host([layout=center])*/[layout=center].sc-calcite-tabs-h{--calcite-tabs-layout:center;--calcite-tabs-tab-basis:200px;--calcite-tabs-tab-text-align:center;--calcite-tabs-tab-margin-start:1.25rem;--calcite-tabs-tab-margin-end:1.25rem}/*!\@:host>div*/.sc-calcite-tabs-h > div.sc-calcite-tabs{height:100%;-ms-flex-direction:column;flex-direction:column}/*!\@:host>div,section*/.sc-calcite-tabs-h > div.sc-calcite-tabs, section.sc-calcite-tabs{display:-ms-flexbox;display:flex}/*!\@section*/section.sc-calcite-tabs{-ms-flex-positive:1;flex-grow:1;overflow:hidden;border-top:1px solid var(--calcite-ui-border-1)}');
