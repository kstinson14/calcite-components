...
styles.set('sc-calcite-tab','/*!\@:host([hidden])*/[hidden].sc-calcite-tab-h{display:none}/*!\@:host([is-active]) section*/[is-active].sc-calcite-tab-h section.sc-calcite-tab{display:block}/*!\@:host*/.sc-calcite-tab-h{display:none}/*!\@:host([is-active])*/[is-active].sc-calcite-tab-h{display:block}/*!\@section*/section.sc-calcite-tab{display:none}');
