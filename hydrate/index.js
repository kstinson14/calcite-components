...
class CalciteButtonWithOverflow {
    ...
    static get cmpMeta() { return {
        "$flags$": 9,
        "$tagName$": "calcite-button-with-overflow",
        "$members$": {
            "color": [1537],
            "theme": [1537],
            "scale": [1537],
...
styles.set('sc-calcite-button-with-overflow','/*!\@:root*/.sc-calcite-button-with-overflow:root{--calcite-ui-blue:#007ac2;--calcite-ui-blue-hover:#2890ce;--calcite-ui-blue-press:#00619b;--calcite-ui-green:#35ac46;--calcite-ui-green-hover:#50ba5f;--calcite-ui-green-press:#288835;--calcite-ui-yellow:#edd317;--calcite-ui-yellow-hover:#f9e54e;--calcite-ui-yellow-press:#d9bc00;--calcite-ui-red:#d83020;--calcite-ui-red-hover:#e65240;--calcite-ui-red-press:#a82b1e;--calcite-ui-background:#f8f8f8;--calcite-ui-foreground:#fff;--calcite-ui-foreground-hover:#f3f3f3;--calcite-ui-foreground-press:#eaeaea;--calcite-ui-text-1:#151515;--calcite-ui-text-2:#4a4a4a;--calcite-ui-text-3:#6a6a6a;--calcite-ui-border-1:#cacaca;--calcite-ui-border-2:#dfdfdf;--calcite-ui-border-3:#eaeaea;--calcite-ui-border-hover:#9f9f9f;--calcite-ui-border-press:#757575}/*!\@:host([theme=dark])*/[theme=dark].sc-calcite-button-with-overflow-h{--calcite-ui-blue:#00a0ff;--calcite-ui-blue-hover:#0087d7;--calcite-ui-blue-press:#47bbff;--calcite-ui-green:#36da43;--calcite-ui-green-hover:#11ad1d;--calcite-ui-green-press:#44ed51;--calcite-ui-yellow:#ffc900;--calcite-ui-yellow-hover:#f4b000;--calcite-ui-yellow-press:#ffe24d;--calcite-ui-red:#fe583e;--calcite-ui-red-hover:#f3381b;--calcite-ui-red-press:#ff7465;--calcite-ui-background:#202020;--calcite-ui-foreground:#2b2b2b;--calcite-ui-foreground-hover:#353535;--calcite-ui-foreground-press:#404040;--calcite-ui-text-1:#fff;--calcite-ui-text-2:#bfbfbf;--calcite-ui-text-3:#9f9f9f;--calcite-ui-border-1:#4a4a4a;--calcite-ui-border-2:#404040;--calcite-ui-border-3:#353535;--calcite-ui-border-hover:#757575;--calcite-ui-border-press:#9f9f9f}/*!\@:root*/.sc-calcite-button-with-overflow:root{--calcite-border-radius:3px}/*!\@:host([hidden])*/[hidden].sc-calcite-button-with-overflow-h{display:none}/*!\@body*/body.sc-calcite-button-with-overflow{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}/*!\@.overflow-hidden*/.overflow-hidden.sc-calcite-button-with-overflow{overflow:hidden}/*!\@calcite-tab*/calcite-tab.sc-calcite-button-with-overflow{display:none}/*!\@calcite-tab[is-active]*/calcite-tab[is-active].sc-calcite-button-with-overflow{display:block}/*!\@a*/a.sc-calcite-button-with-overflow{color:#007ac2}/*!\@.hydrated--invisible*/.hydrated--invisible.sc-calcite-button-with-overflow{visibility:hidden}/*!\@:host*/.sc-calcite-button-with-overflow-h{--calcite-button-light:#f3f3f3;--calcite-button-light-text:#151515;--calcite-button-dark:#353535;--calcite-button-colored-dark-theme-text:#0b0b0b}/*!\@:host>div*/.sc-calcite-button-with-overflow-h > div.sc-calcite-button-with-overflow{display:-ms-flexbox;display:flex}/*!\@:host calcite-icon*/.sc-calcite-button-with-overflow-h calcite-icon.sc-calcite-button-with-overflow{pointer-events:none}/*!\@:host([color=blue]) .divider-container*/[color=blue].sc-calcite-button-with-overflow-h .divider-container.sc-calcite-button-with-overflow{background-color:var(--calcite-ui-blue)}/*!\@:host([color=blue]):host([theme=dark]) .divider*/[color=blue].sc-calcite-button-with-overflow-h ([theme=dark]).sc-calcite-button-with-overflow-h .divider.sc-calcite-button-with-overflow{background-color:var(--calcite-button-colored-dark-theme-text)}/*!\@:host([color=red]) .divider-container*/[color=red].sc-calcite-button-with-overflow-h .divider-container.sc-calcite-button-with-overflow{background-color:var(--calcite-ui-red)}/*!\@:host([color=red]):host([theme=dark]) .divider*/[color=red].sc-calcite-button-with-overflow-h ([theme=dark]).sc-calcite-button-with-overflow-h .divider.sc-calcite-button-with-overflow{background-color:var(--calcite-button-colored-dark-theme-text)}/*!\@:host([color=light]) .divider-container*/[color=light].sc-calcite-button-with-overflow-h .divider-container.sc-calcite-button-with-overflow{background-color:var(--calcite-button-light)}/*!\@:host([color=light]) .divider*/[color=light].sc-calcite-button-with-overflow-h .divider.sc-calcite-button-with-overflow{background-color:var(--calcite-button-light-text)}/*!\@:host([color=dark]) .divider-container*/[color=dark].sc-calcite-button-with-overflow-h .divider-container.sc-calcite-button-with-overflow{background-color:var(--calcite-button-dark)}/*!\@:host([disabled]) .divider-container*/[disabled].sc-calcite-button-with-overflow-h .divider-container.sc-calcite-button-with-overflow{opacity:.4}/*!\@:host([disabled]) calcite-dropdown>calcite-button*/[disabled].sc-calcite-button-with-overflow-h calcite-dropdown.sc-calcite-button-with-overflow > calcite-button.sc-calcite-button-with-overflow{pointer-events:none}/*!\@.divider-container*/.divider-container.sc-calcite-button-with-overflow{width:1px;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}/*!\@.divider*/.divider.sc-calcite-button-with-overflow{width:1px;height:66.666%;display:inline-block;background-color:#fff}');
