...
styles.set('sc-calcite-tab','/*!\@:host([hidden])*/[hidden].sc-calcite-tab-h{display:none}/*!\@:host([is-active]) section*/[is-active].sc-calcite-tab-h section.sc-calcite-tab{display:block}/*!\@:host*/.sc-calcite-tab-h{display:none}/*!\@:host([is-active])*/[is-active].sc-calcite-tab-h{display:block}/*!\@section*/section.sc-calcite-tab{height:100%;display:none}');
...
styles.set('sc-calcite-tabs','/*!\@:host([hidden])*/[hidden].sc-calcite-tabs-h{display:none}/*!\@:host*/.sc-calcite-tabs-h{display:block;--calcite-tabs-layout:flex-start;--calcite-tabs-tab-basis:auto;--calcite-tabs-tab-text-align:start;--calcite-tabs-tab-margin-start:1.25rem;--calcite-tabs-tab-margin-end:0}/*!\@:host-context([dir=rtl])*/[dir=rtl].sc-calcite-tabs-h, [dir=rtl] .sc-calcite-tabs-h{--calcite-tabs-tab-margin-start:0;--calcite-tabs-tab-margin-end:1.25rem}/*!\@:host([layout=center])*/[layout=center].sc-calcite-tabs-h{--calcite-tabs-layout:center;--calcite-tabs-tab-basis:200px;--calcite-tabs-tab-text-align:center;--calcite-tabs-tab-margin-start:1.25rem;--calcite-tabs-tab-margin-end:1.25rem}/*!\@:host>div*/.sc-calcite-tabs-h > div.sc-calcite-tabs{height:100%;display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column}/*!\@section*/section.sc-calcite-tabs{height:100%;border-top:1px solid var(--calcite-ui-border-1)}');
