...
class CalciteButton {
    ...
    static get cmpMeta() { return {
        ...
        "$members$": {
            ...
            "scale": [1537],
            "width": [1537],
            "textlessHeight": [1537, "textless-height"],
            "loading": [516],
            "round": [516],
            "floating": [516],
            "href": [513],
...
class CalciteButtonWithOverflow {
    ...
    render() {
        const dir = getElementDir(this.el);
        return (h(Host, { dir: dir }, h("div", null, h("calcite-button", { color: this.color, scale: this.scale, loading: this.loading, disabled: this.disabled, theme: this.theme, onClick: this.primaryButtonClickedHandler }, this.primaryText), h("div", { class: 'divider-container' }, h("div", { class: 'divider' })), h("calcite-dropdown", { dir: dir, theme: this.theme, scale: this.dropdownScale, width: this.dropdownScale }, h("calcite-button", { "aria-label": this.dropdownLabel, slot: "dropdown-trigger", scale: this.scale, color: this.color, disabled: this.disabled, theme: this.theme, icon: 'caretDown', "textless-height": 'full' }), h("slot", null)))));
    }
    get dropdownScale() {
        const scaleLookup = {
            'xs': 's',
