...
const CalciteButtonWithOverflow = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { dir: dir }, core.h("div", null, core.h("calcite-button", { color: this.color, scale: this.scale, loading: this.loading, disabled: this.disabled, theme: this.theme, onClick: this.primaryButtonClickedHandler }, this.primaryText), core.h("div", { class: 'divider-container' }, core.h("div", { class: 'divider' })), core.h("calcite-dropdown", { alignment: this.dropdownAlignment, theme: this.theme, scale: this.dropdownScale, width: this.dropdownScale }, core.h("calcite-button", { "aria-label": this.overflowLabel, slot: "dropdown-trigger", scale: this.scale, color: this.color, disabled: this.disabled, theme: this.theme, icon: 'caretDown', "textless-height": 'full' }), core.h("slot", null)))));
    }
...
exports.calcite_button_with_overflow = CalciteButtonWithOverflow;
