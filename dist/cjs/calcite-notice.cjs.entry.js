...
const CalciteNotice = class {
    ...
    render() {
        const closeButton = (core.h("button", { class: "notice-close", "aria-label": "close", onClick: () => this.close(), ref: el => (this.closeButton = el) }, core.h("calcite-icon", { icon: "x", scale: "m" })));
        return (core.h(core.Host, { active: this.active }, this.icon ? this.setIcon() : null, core.h("div", { class: "notice-content" }, core.h("slot", { name: "notice-title" }), core.h("slot", { name: "notice-message" }), core.h("slot", { name: "notice-link" })), this.dismissible ? closeButton : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
