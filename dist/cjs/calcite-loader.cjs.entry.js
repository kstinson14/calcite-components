...
const CalciteLoader = class {
    ...
    render() {
        ...
        return (core.h(core.Host, Object.assign({ id: id, role: "progressbar" }, (isDeterminate ? hostAttributes : {})), core.h("div", { class: "loader__svgs" }, core.h("svg", { viewBox: viewbox, class: "loader__svg loader__svg--1" }, core.h("circle", Object.assign({}, svgAttributes))), core.h("svg", { viewBox: viewbox, class: "loader__svg loader__svg--2" }, core.h("circle", Object.assign({}, svgAttributes))), core.h("svg", Object.assign({ viewBox: viewbox, class: "loader__svg loader__svg--3" }, (isDeterminate ? { style: determinateStyle } : {})), core.h("circle", Object.assign({}, svgAttributes)))), this.text && core.h("div", { class: "loader__text" }, this.text), isDeterminate && core.h("div", { class: "loader__percentage" }, value)));
    }
