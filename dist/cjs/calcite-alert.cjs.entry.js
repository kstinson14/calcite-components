...
const CalciteAlert = class {
    ...
    render() {
        const closeButton = (core.h("button", { class: "alert-close", "aria-label": "close", onClick: () => this.close(), ref: el => (this.closeButton = el) }, core.h("calcite-icon", { icon: "x", scale: "m" })));
        ...
        const role = !this.active
            ...
            : this.autoDismiss
                ? "alert"
                : "alertdialog";
        return (core.h(core.Host, { active: this.active, role: role }, this.icon ? this.setIcon() : null, core.h("div", { class: "alert-content" }, core.h("slot", { name: "alert-title" }), core.h("slot", { name: "alert-message" }), core.h("slot", { name: "alert-link" })), count, !this.autoDismiss ? closeButton : null, this.active && this.autoDismiss ? progress : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
