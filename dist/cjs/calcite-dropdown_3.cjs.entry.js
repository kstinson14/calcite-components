...
const CalciteDropdown = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { active: this.active, id: this.dropdownId }, core.h("slot", { name: "dropdown-trigger", "aria-haspopup": "true", "aria-expanded": expanded }), core.h("div", { class: "calcite-dropdown-wrapper", role: "menu" }, core.h("slot", null))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const CalciteDropdownItem = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { tabindex: "0", role: "menuitem", "selection-mode": this.selectionMode, "aria-selected": this.active.toString(), isLink: this.href }, this.selectionMode === "multi" ? (core.h("calcite-icon", { class: "dropdown-item-check-icon", scale: "s", icon: "check" })) : null, contentEl));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
