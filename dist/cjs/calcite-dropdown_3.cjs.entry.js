...
const CalciteDropdownItem = class {
    ...
    render() {
        ...
        const contentEl = !this.href ? (slottedContent) : (core.h("a", Object.assign({}, attributes), slottedContent));
        return (core.h(core.Host, { dir: dir, tabindex: "0", role: "menuitem", "selection-mode": this.selectionMode, "aria-selected": this.active.toString(), isLink: this.href }, this.selectionMode === "multi" ? (core.h("calcite-icon", { class: "dropdown-item-check-icon", scale: "s", icon: "check" })) : null, contentEl));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
