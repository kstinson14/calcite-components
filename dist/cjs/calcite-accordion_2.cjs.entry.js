...
const CalciteAccordionItem = class {
    ...
    render() {
        return (core.h(core.Host, { tabindex: "0", "aria-expanded": this.active.toString() }, core.h("div", { class: "accordion-item-header", onClick: this.itemHeaderClickHander }, core.h("div", { class: "accordion-item-header-text" }, core.h("span", { class: "accordion-item-title" }, this.itemTitle), core.h("span", { class: "accordion-item-subtitle" }, this.itemSubtitle)), core.h("calcite-icon", { class: "accordion-item-icon", icon: this.iconType === "chevron"
                ? "chevronUp"
                : this.iconType === "caret"
                    ? "caretUp"
                    : this.active
