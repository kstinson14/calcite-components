...
const CalciteSlider = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { id: id, "is-range": this.isRange }, core.h("div", { class: "slider__track" }, core.h("div", { class: "slider__track__range", style: { left, right } }), core.h("div", { class: "slider__ticks" }, this.tickValues.map(number => (core.h("span", { class: {
                slider__tick: true,
