...
const CalciteTabs = class {
    ...
    //--------------------------------------------------------------------------
    render() {
        return (core.h(core.Host, null, core.h("div", null, core.h("slot", { name: "tab-nav" }), core.h("section", null, core.h("slot", null)))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
