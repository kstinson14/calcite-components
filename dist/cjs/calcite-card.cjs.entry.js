...
const CalciteCard = class {
    ...
    render() {
        return (core.h(core.Host, null, core.h("div", { class: "calcite-card-container" }, this.loading ? (core.h("div", { class: "calcite-card-loader-container" }, core.h("calcite-loader", { class: "calcite-card-loader", "is-active": true }))) : null, core.h("section", { class: { [CSS.container]: true }, "aria-busy": this.loading }, this.selectable ? this.renderCheckbox() : null, this.renderThumbnail(), this.renderHeader(), core.h("div", { class: "card-content" }, core.h("slot", null)), this.renderFooter()))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private State/Props
