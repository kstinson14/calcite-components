...
const CalciteModal = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { role: "dialog", "aria-modal": "true", class: { "is-active": this.isActive }, theme: theme }, core.h("div", { class: "modal" }, core.h("div", { "data-focus-fence": "true", tabindex: "0", onFocus: this.focusLastElement.bind(this) }), core.h("div", { class: "modal__header" }, core.h("button", { class: "modal__close", "aria-label": this.closeLabel, ref: el => (this.closeButton = el), onClick: () => this.close() }, core.h("calcite-icon", { icon: "x", scale: "m" })), core.h("header", { class: "modal__title" }, core.h("slot", { name: "header" }))), core.h("div", { class: {
                modal__content: true,
