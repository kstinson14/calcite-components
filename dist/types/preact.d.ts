...
declare module "preact/src/jsx" {
  namespace JSXInternal {
    interface IntrinsicElements {
      ...
      "calcite-date": Omit<JSX.CalciteDate, "onCalciteDateChange" | "onCalciteDateRangeChange"> & JSXInternal.HTMLAttributes<HTMLCalciteDateElement> & {
        "oncalciteDateChange"?: (event: CustomEvent<any>) => void;
        "oncalciteDateRangeChange"?: (event: CustomEvent<any>) => void;
      }

      "calcite-date-day": Omit<JSX.CalciteDateDay, "onCalciteDaySelect" | "onCalciteDayHover"> & JSXInternal.HTMLAttributes<HTMLCalciteDateDayElement> & {
        "oncalciteDaySelect"?: (event: CustomEvent<any>) => void;
        "oncalciteDayHover"?: (event: CustomEvent<any>) => void;
      }

      "calcite-date-month": Omit<JSX.CalciteDateMonth, "onCalciteDateSelect" | "onCalciteDateHover" | "onCalciteActiveDateChange" | "onCalciteDateMouseOut"> & JSXInternal.HTMLAttributes<HTMLCalciteDateMonthElement> & {
      ...
      "calcite-date-month-header": Omit<JSX.CalciteDateMonthHeader, "onCalciteDateSelect"> & JSXInternal.HTMLAttributes<HTMLCalciteDateMonthHeaderElement> & {
        "oncalciteDateSelect"?: (event: CustomEvent<any>) => void;
      }
