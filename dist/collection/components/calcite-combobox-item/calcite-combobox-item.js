...
export class CalciteComboboxItem {
  ...
  render() {
    ...
    return (h(Host, { "aria-selected": this.isSelected.toString(), dir: dir, disabled: this.disabled, role: "option", scale: scale, tabIndex: this.disabled ? null : 0 },
  ...
  static get properties() { return {
    ...
    "parentItem": {
      ...
      "docs": {
        "tags": [],
        "text": "The parent combobox item element"
      }
    },
    "selected": {
      "type": "boolean",
