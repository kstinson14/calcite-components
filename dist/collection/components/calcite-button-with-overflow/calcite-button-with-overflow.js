...
export class CalciteButtonWithOverflow {
        ...
        return (h(Host, { dir: dir },
            h("div", null,
                ...
                h("div", { class: 'divider-container' },
                    h("div", { class: 'divider' })),
                h("calcite-dropdown", { alignment: this.dropdownAlignment, theme: this.theme, scale: this.dropdownScale, width: this.dropdownScale },
                    h("calcite-button", { "aria-label": this.overflowLabel, slot: "dropdown-trigger", scale: this.scale, color: this.color, disabled: this.disabled, theme: this.theme, icon: 'caretDown', "textless-height": 'full' }),
                    h("slot", null)))));
    }
    ...
    static get is() { return "calcite-button-with-overflow"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() { return {
        "$": ["calcite-button-with-overflow.scss"]
    }; }
    static get styleUrls() { return {
        "$": ["calcite-button-with-overflow.css"]
    }; }
